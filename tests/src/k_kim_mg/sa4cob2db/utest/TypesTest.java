...
public class TypesTest {
	...
	public void testTYPE_0() {
		...
		try {
			...
			assertEquals(column.getName() + " failed(" + record.getString(column) + ")", x, record.getString(column));
	...
	public void testTYPE_9() {
		...
		try {
			...
			assertEquals(column.getName() + " failed(" + column.getFormat() + ")", "000000000000005678", record.getString(column));
		} catch (CobolRecordException e) {
			e.printStackTrace();
			fail(e.getMessage());
		}
	...
	public void testTYPE_V() {
		...
		try {
			...
			assertEquals(column.getName() + " failed(" + record.getString(column) + ")", 0.0f, f, record.getFloat(column));
		} catch (CobolRecordException e) {
			e.printStackTrace();
			fail(e.getMessage());
		}
	...
	public void testTYPE_SLASH() {
		...
		try {
			...
			record.updateInt(column, i);
			assertEquals(column.getName() + " failed(" + record.getString(column) + ")", i, record.getInt(column));
			assertEquals(column.getName() + " failed(" + column.getFormat() + ")", "56/78", record.getString(column));
		} catch (CobolRecordException e) {
			e.printStackTrace();
			fail(e.getMessage());
		}
	...
	public void testTYPE_PERIOD() {
		...
		try {
			...
			record.updateFloat(column, f);
			assertEquals(column.getName() + " failed(" + record.getString(column) + ")", 0.0f, f, record.getFloat(column));
			assertEquals(column.getName() + " failed(" + column.getFormat() + ")", "5.67", record.getString(column));
		} catch (CobolRecordException e) {
			e.printStackTrace();
			fail(e.getMessage());
		}
	...
	public void testTYPE_CR1() {
		...
		try {
			...
			record.updateInt(column, i);
			assertEquals(column.getName() + " failed(" + record.getString(column) + ")", i, record.getInt(column));
			assertEquals(column.getName() + " failed(" + column.getFormat() + ")", "5  ", record.getString(column));
		} catch (CobolRecordException e) {
			e.printStackTrace();
			fail(e.getMessage());
		}
	...
	public void testTYPE_CR2() {
		...
		try {
			...
			record.updateInt(column, i);
			assertEquals(column.getName() + " failed(" + record.getString(column) + ")", i, record.getInt(column));
			assertEquals(column.getName() + " failed(" + column.getFormat() + ")", "5CR", record.getString(column));
		} catch (CobolRecordException e) {
			e.printStackTrace();
			fail(e.getMessage());
		}
	...
	public void testTYPE_DB2() {
		...
		try {
			...
			record.updateInt(column, i);
			assertEquals(column.getName() + " failed(" + record.getString(column) + ")", i, record.getInt(column));
			assertEquals(column.getName() + " failed(" + column.getFormat() + ")", "5DB", record.getString(column));
		} catch (CobolRecordException e) {
			e.printStackTrace();
			fail(e.getMessage());
		}
