...
public class ACMServerEventAdapterTest extends ACMServerEventAdapter {
	 ...
	 * 
	 * @see
	 * k_kim_mg.sa4cob2db.event.ACMServerEventAdapter#sessionAdded(k_kim_mg.
	 * sa4cob2db.event.ACMServerEvent, k_kim_mg.sa4cob2db.ACMSession)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * k_kim_mg.sa4cob2db.event.ACMServerEventAdapter#sessionRemoved(k_kim_mg
	 * .sa4cob2db.event.ACMServerEvent, k_kim_mg.sa4cob2db.ACMSession)
	 */
	@Override
