...
public interface CobolFile extends Serializable {
	...
	/**
	 * ファイルオープン
	 * @param mode モード オープンモード input/output/expant/input-output
	 * @param accessmode アクセスモードまたはファイル構成 sequencial/random/dynamic
	 * @return ステータス
	 */
	 ...
	 * @param listener 削除するCobolFileEventListener
	 */
	 ...
	 * @param record 検索レコード
	 * @return ステータス
	 * @throws CobolRecordException エラー発生時
	 */
	 ...
	 * @param mode モード(EQ GT など)
	 * @param record キーを含むレコード
	 * @param duplicates キーが重複しているかどうか
	 * @return ステータス
	 */
