...
public class DefaultSQLCobolRecordMetaData2 extends DefaultSQLCobolRecordMetaData implements
    SQLCobolRecordMetaData2 {
   ...
   * (non-Javadoc)
   * 
   * @see k_kim_mg.sa4cob2db.DefaultCobolRecordMetaData#addKey(k_kim_mg.sa4cob2db .CobolColumn)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see k_kim_mg.sa4cob2db.sql.DefaultSQLCobolRecordMetaData#setSelectStatement(java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see k_kim_mg.sa4cob2db.sql.SQLCobolRecordMetaData2#setEntityName(java.lang .String)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see k_kim_mg.sa4cob2db.sql.SQLCobolRecordMetaData2#setKeyReadStatement(java .lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see k_kim_mg.sa4cob2db.sql.SQLCobolRecordMetaData2#setStartGEStatement(java .lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see k_kim_mg.sa4cob2db.sql.SQLCobolRecordMetaData2#setStartGTStatement(java .lang.String)
   */
  @Override
