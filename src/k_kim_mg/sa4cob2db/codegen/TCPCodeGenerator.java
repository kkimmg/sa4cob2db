...
public class TCPCodeGenerator implements CodeGenerator {
   ...
   * 
   * @param text
   *          string includes transaction level
   */
   ...
   * 
   * @param valid
   *          Lines that runs when file access is valid.
   * @param invalid
   *          Lines that runs when file access is invalid.
   * @param period
   *          "." or ""
   */
   ...
   *          file information
   * @param atend
   *          Lines that runs when file at end.
   * @param notatend
   *          Lines that runs when file not at end.
   * @param indexkey
   *          index name
   * @param period
   *          "." or ""
    ...
    while (tokenizer.hasNext()) {
      ...
      if (token.equalsIgnoreCase("START")) {
        ...
        if (_start.equalsIgnoreCase("START") && _file.equalsIgnoreCase("")) {
          ...
          if ((prev.equalsIgnoreCase("TO") && prev2.equalsIgnoreCase("EQUAL")
              && prev3.equalsIgnoreCase("IS") && prev4.equalsIgnoreCase("KEY"))
              || (prev.equalsIgnoreCase("=") && prev2.equalsIgnoreCase("IS") && prev3
                  .equalsIgnoreCase("KEY"))) {
            // startmode = CobolFile.IS_EQUAL_TO;
            startmodetext = "IS-EQUAL-TO";
            indexkey = token;
          } else if ((prev.equalsIgnoreCase("THAN") && prev2.equalsIgnoreCase("GRATER")
              && prev3.equalsIgnoreCase("IS") && prev4.equalsIgnoreCase("KEY"))
              || (prev.equalsIgnoreCase(">") && prev2.equalsIgnoreCase("IS") && prev3
                  .equalsIgnoreCase("KEY"))) {
            ...
            indexkey = token;
          } else if ((prev.equalsIgnoreCase("THAN") && prev2.equalsIgnoreCase("LESS")
              && prev3.equalsIgnoreCase("NOT") && prev4.equalsIgnoreCase("IS") && prev5
                .equalsIgnoreCase("KEY"))
              || (prev.equalsIgnoreCase("<") && prev2.equalsIgnoreCase("NOT")
                  && prev3.equalsIgnoreCase("IS") && prev4.equalsIgnoreCase("KEY"))
              || (prev.equalsIgnoreCase("TO") && prev2.equalsIgnoreCase("EQUAL")
                  && prev3.equalsIgnoreCase("OR") && prev4.equalsIgnoreCase("THAN")
                  && prev5.equalsIgnoreCase("GREATER") && prev6.equalsIgnoreCase("IS") && prev7
                    .equalsIgnoreCase("KEY"))
              || (prev.equalsIgnoreCase(">=") && prev2.equalsIgnoreCase("IS") && prev3
                  .equalsIgnoreCase("KEY"))) {
  ...
  void whenNoMatchAny(String text) {
    if (inCopy && isExpandCopy()) {
      ...
      if (current == CobolConsts.SELECT) {
        ...
        commentOut(text);
        currentlist.add(text);
      } else if (current == CobolConsts.READ || current == CobolConsts.WRITE
          || current == CobolConsts.REWRITE || current == CobolConsts.DELETE
