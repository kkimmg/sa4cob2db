...
/**
 * deffault implement of ACMServerEventListener<br/>
 * 
...
public class ACMServerEventAdapter implements ACMServerEventListener {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see k_kim_mg.sa4cob2db.event.ACMServerEventListener#serverEnding
	 ...
	 * (non-Javadoc)
	 * 
	 * @see k_kim_mg.sa4cob2db.event.ACMServerEventListener#serverStarted
	 * (k_kim_mg.sa4cob2db.event.ACMServerEvent)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see k_kim_mg.sa4cob2db.event.ACMServerEventListener#sessionAdded
	 * (k_kim_mg.sa4cob2db.event.ACMServerEvent, k_kim_mg.sa4cob2db.ACMSession)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see k_kim_mg.sa4cob2db.event.ACMServerEventListener#sessionRemoved
	 * (k_kim_mg.sa4cob2db.event.ACMServerEvent, k_kim_mg.sa4cob2db.ACMSession)
	 */
