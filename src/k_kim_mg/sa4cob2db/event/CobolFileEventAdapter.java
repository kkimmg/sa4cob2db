...
/**
 * default implement of CobolFileEventListener
 * 
...
public class CobolFileEventAdapter implements CobolFileEventListener {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see k_kim_mg.sa4cob2db.event.CobolFileEventListener#postPrevious
	 * (k_kim_mg.sa4cob2db.event.CobolFileEvent)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see k_kim_mg.sa4cob2db.event.CobolFileEventListener#preMove(jp
	 ...
	 * (non-Javadoc)
	 * 
	 * @see k_kim_mg.sa4cob2db.event.CobolFileEventListener#preNext(jp
	 ...
	 * (non-Javadoc)
	 * 
	 * @see k_kim_mg.sa4cob2db.event.CobolFileEventListener#preOpen(jp
	 * .ne.biglobe.mvh.k_kim_mg.acm.event.CobolFileEvent)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see k_kim_mg.sa4cob2db.event.CobolFileEventListener#preRead(jp
	 * .ne.biglobe.mvh.k_kim_mg.acm.event.CobolFileEvent)
	 */
