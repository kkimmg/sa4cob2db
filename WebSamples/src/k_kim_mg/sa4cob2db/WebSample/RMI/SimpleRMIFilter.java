...
public class SimpleRMIFilter implements Filter {
  ...
  private void addExceptionMessage(ServletRequest req, Exception ex) {
    ...
    req.setAttribute(SimpleProcessFilter.ACM_ERRORS,
        req.getAttribute(SimpleProcessFilter.ACM_ERRORS) + ex.getMessage());
  }
  ...
  public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
    ...
    req.setAttribute(SimpleProcessFilter.ACM_ERRORS,
        req.getAttribute(SimpleProcessFilter.ACM_ERRORS));
    //
  ...
  public void init(FilterConfig config) throws ServletException {
    ...
    InputStream in = Thread.currentThread().getContextClassLoader()
        .getResourceAsStream(SimpleProcessFilter.PRPFNAME);
    try {
      prop.load(in);
  ...
  protected void setByte2Request(CobolRecordMetaData meta, byte[] byt, ServletRequest req) {
    ...
    req.setAttribute(SimpleProcessFilter.ACM_ERRORS, (errors == null ? buf.toString() : errors
        + "<br>\n" + buf.toString()));
  }
   ...
   *           exception
   */
  protected void setRecordToRequest(CobolRecord record, HttpServletRequest request)
      throws ServletException, IOException, CobolRecordException {
   ...
   *           exception
   */
  protected void setRequestToRecord(HttpServletRequest request, CobolRecord record)
