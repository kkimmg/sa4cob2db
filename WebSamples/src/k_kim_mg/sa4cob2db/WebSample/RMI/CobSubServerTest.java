...
public class CobSubServerTest {
	...
	CobolRecordMetaData metaHead;
	CobolRecordMetaData metaReqInp;
	CobolRecordMetaData metaReqOut;
	CobolRecord head;
	JSampleJniCall1 jni;
	...
	public static void main(String[] args) {
		...
		/*
		 * try { ins.setUp(); ins.testRead(); } catch (Exception e) {
		 * e.printStackTrace(); }
		 */
		try {
			ins.setUp();
	...
	public void setUp() throws Exception {
		...
		String filename = System.getenv(ENV_NAME);
