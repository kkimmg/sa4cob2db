...
000320*主処理節
000330     CALL "initializeSessionEnv" USING ACM-STATUS-ALL.
000340     PERFORM   INIT.
...
000440     PERFORM   TERM.
000450     CALL  "terminateSession" USING ACM-STATUS-ALL.
000460     STOP RUN.
000470*開始処理
000480 INIT                        SECTION.
...
000550     CALL "assignACMFile" USING ACM-FILE-IDENT ACM-STATUS-ALL.
000560     CALL "openACMFile"   USING ACM-FILE-IDENT
...
000690     CALL "startACMRecordWith" USING ACM-FILE-IDENT
000700                                ACM-RECORD
...
000840     CALL "readNextACMRecord" USING 
...
001080     CALL "closeACMFile" USING ACM-FILE-IDENT ACM-STATUS-ALL.
001090     EXIT.
001100*終了処理
001110 TERM                        SECTION.
