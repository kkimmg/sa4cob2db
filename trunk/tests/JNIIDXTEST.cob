...
000330*主処理節
000340     CALL "initializeJNISessionEnv" USING ACM-STATUS-ALL.
000350     PERFORM   INIT.
...
000450     PERFORM   TERM.
000460     CALL  "terminateJNISession" USING ACM-STATUS-ALL.
000470     STOP RUN.
000480*開始処理
000490 INIT                        SECTION.
...
000560     CALL "assignJNIFile" USING ACM-FILE-IDENT ACM-STATUS-ALL.
000570     CALL "openJNIFile"   USING ACM-FILE-IDENT
...
000700     CALL "startJNIRecordWith" USING ACM-FILE-IDENT
000710                                ACM-RECORD
...
000850     CALL "readNextJNIRecord" USING 
...
001090     CALL "closeJNIFile" USING ACM-FILE-IDENT ACM-STATUS-ALL.
001100     EXIT.
001110*終了処理
001120 TERM                        SECTION.
