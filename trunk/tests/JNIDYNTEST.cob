...
000380*主処理節
000390     CALL "initializeJNISessionEnv" USING ACM-STATUS-ALL.
000400     PERFORM   INIT.
...
000650     PERFORM   TERM.
000660     CALL  "terminateJNISession" USING ACM-STATUS-ALL.
000670     STOP RUN.
000680*開始処理
000690 INIT SECTION.
...
000760     CALL "assignJNIFile" USING ACM-FILE-IDENT ACM-STATUS-ALL.
000770     CALL "openJNIFile"   USING ACM-FILE-IDENT
...
000920     CALL "moveReadJNIRecord" USING 
...
001210     CALL "writeJNIRecord" USING ACM-FILE-IDENT
001220                                 ACM-RECORD
...
001430     CALL "rewriteJNIRecord" USING ACM-FILE-IDENT
001440                                   ACM-RECORD
...
001660     CALL "deleteJNIRecord" USING ACM-FILE-IDENT
001670                                  ACM-RECORD
...
002200     CALL "closeJNIFile" USING ACM-FILE-IDENT ACM-STATUS-ALL.
002210     EXIT.
002220*終了処理
002230 TERM SECTION.
