...
000760     PERFORM   TERM.
000770     CALL  "terminateJNISession" USING ACM-STATUS-ALL.
000780     STOP RUN.
000790*開始処理
000800 INIT SECTION.
...
000870     CALL "assignJNIFile" USING ACM-FILE-IDENT ACM-STATUS-ALL.
000880     CALL "openJNIFile"   USING ACM-FILE-IDENT
...
001030     CALL "moveReadJNIRecord" USING 
...
001320     CALL "writeJNIRecord" USING ACM-FILE-IDENT
001330                                 ACM-RECORD
...
001540     CALL "rewriteJNIRecord" USING ACM-FILE-IDENT
001550                                   ACM-RECORD
...
001770     CALL "deleteJNIRecord" USING ACM-FILE-IDENT
001780                                  ACM-RECORD
...
002480     CALL "closeJNIFile" USING ACM-FILE-IDENT ACM-STATUS-ALL.
002490     EXIT.
002500*終了処理
002510 TERM SECTION.
